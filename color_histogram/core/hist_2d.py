...
from color_histogram.core.hist_common import colorCoordinates, colorDensities, rgbColors, colorCounts, clipLowDensity, range2ticks,\
...
class Hist2D:
    ...
    def colorCounts(self):
        return colorCounts(self._hist_bins)
    ...
    def _computeTargetPixels(self, image, color_space, channels):
        ...
        # num_pixels = h*w
        num_pixels = 1000
        color_pixels = ColorPixels(image, num_pixels=num_pixels)
